...
export const questions: readonly Question[] = [
  ...
  },
  {
    id: 'safety-need',
    kind: 'slider',
    prompt: 'How much does feeling safe walking home alone late at night factor into where you\'d live?',
    lowLabel: 'Not a strong factor for me',
    highLabel: 'I need to feel safe at all hours',
    dimensionId: 'safety-need',
  },
  {
    id: 'school-need',
    kind: 'slider',
    prompt: 'How much does zoned public school quality factor into your decision?',
    lowLabel: 'Not a factor for me',
    highLabel: 'Top-rated schools required',
