...
export const neighborhoods: readonly Neighborhood[] = [
  ...
  },
  {
    ...
    scores: {
      'urban-intensity-tolerance': -0.3, 'transit-psychology': 0.7, 'prestige-orientation': 0.4,
      'space-sensitivity': 0.5, 'family-trajectory': 0.85, 'cultural-ecosystem': 0.4,
      'environmental-openness': 0.5, 'creative-energy': 0.3, 'friction-sensitivity': 0.8,
      'safety-need': 0.85, 'school-quality': 0.6,
    'social-register': -0.6,
    'visitor-facing-energy': -0.6,
  ...
  },
{
  ...
  'social-register': 0.9,
  'visitor-facing-energy': -0.7,
  'built-form-register': -0.6, 'rootedness-vs-access': -0.9, 'daily-life-walkability': 0.55,  'streetscape-quality': 0.55,  'community-fabric': -0.85, },
    carDependent: true, housingTypes: ['single-family'],
    hasQuietBlocks: true,
    hasFamilyInfrastructure: true,
