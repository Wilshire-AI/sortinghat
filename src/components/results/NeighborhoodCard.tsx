...
export function NeighborhoodCard({ rank, neighborhood, prose, score }: Props) {
  return (
    <article className="border-t border-[var(--color-line)] first:border-t-0 py-12 sm:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-[2fr_3fr] gap-8 sm:gap-12 items-start">
        <div className={`borough-${neighborhood.borough} aspect-[4/5] rounded-sm overflow-hidden flex flex-col justify-end p-6 text-[var(--color-bg)] shadow-md`}>
          <p className="text-[10px] uppercase tracking-[0.22em] opacity-90">
            № {String(rank).padStart(2, '0')}
          </p>
          <p className="mt-2 font-serif text-3xl sm:text-4xl leading-tight">
        ...
        <div>
          ...
          <h2 className="mt-2 font-serif text-3xl sm:text-4xl leading-tight">
